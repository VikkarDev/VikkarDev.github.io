...
if (!localStorage.getItem('ythwes')) localStorage.setItem('ythwes', 0);
...
function load() {
    document.getElementById('ytbtn').addEventListener('mouseover', () => {
        document.getElementById('mode-desc').innerHTML = "Pick the more popular option between two of Wes and Steph's 1300+ YouTube videos"
